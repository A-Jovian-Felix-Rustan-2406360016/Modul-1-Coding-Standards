...
class EditProductFunctionalTest {
    ...
    void editProduct_isSuccessful(ChromeDriver driver) {
        ...
        driver.findElement(By.xpath("//td[contains(text(), '" + originalName + "')]/following-sibling::td/a[contains(@class, 'btn-warning')]")).click();
        ...
        assertFalse(pageSource.contains(originalName));
    }
}
